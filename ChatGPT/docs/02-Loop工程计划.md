...
更新：2026-09-19。此规划替代早期平台接口开发方案。工程根为 `/Users/yihun/Code/Project/2026 HW Comp/CoreGeek/ChatGPT`，全部写入限于该目录；原始规则在工程根 `../../docs/`，只读。先读 [接手入口](../AGENT.md) 和 [v0.7归档](design/08-v07角色目标与沙盒任务实施.md)。
